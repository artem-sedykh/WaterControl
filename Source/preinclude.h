...
#define BDBREPORTING_MAX_ANALOG_ATTR_SIZE 6
#define BDB_MAX_CLUSTERENDPOINTS_REPORTING 8 
#define BDBREPORTING_DEFAULTCHANGEVALUE {0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
