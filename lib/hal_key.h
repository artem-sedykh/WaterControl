...
#define HAL_KEY_PRESSED_BIT               BV(7)
#define SET_HAL_KEY_PRESSED(NUMBER)       st(NUMBER |= HAL_KEY_PRESSED_BIT;)
#define HAL_IS_KEY_PRESSED(NUMBER)        (NUMBER & HAL_KEY_PRESSED_BIT) ? 1 : 0
#define HAL_CLEAR_KEY_PRESSED_BIT(NUMBER) (NUMBER & ~(HAL_KEY_PRESSED_BIT))
