...
zclWriteAttrDataCB_t zcl_WriteAttrDataCB = (zclWriteAttrDataCB_t)NULL;
...
ZStatus_t zcl_registerWriteAttrDataCB( zclWriteAttrDataCB_t pfnWriteAttrData )
{
  zcl_WriteAttrDataCB = pfnWriteAttrData;
