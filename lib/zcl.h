...
typedef uint8 (*zclValidateAttrData_t)( uint8 endPoint, zclAttrRec_t *pAttr, zclWriteRec_t *pAttrInfo );

typedef void (*zclWriteAttrDataCB_t)( uint8 endPoint, zclAttrRec_t *pAttr);
...
extern ZStatus_t zcl_registerWriteAttrDataCB( zclWriteAttrDataCB_t pfnWriteAttrData );
